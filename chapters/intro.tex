...
\todoi{something about quotients in set theory and how this is not
  always straightforward, \eg comments from Conway about defining
  surreal numbers in ZFC. Also how one typically needs choice in order
  to do things.}
