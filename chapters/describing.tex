...
implementable in a small core type theory, where one would not expect
to have induction-recursion available. A class of inductive-recursive
definitions can be translated into definitions making use of indexed
inductive definitions instead \cite{Malatesta2012}. In this section we
will use a different translation, which does not need indexed
