...
We have now given all the ingredients needed to show that the
categories of algebras all have initial objects, given that the
arguments functors preserve sequential colimits.
...
\subsection{Moving to arbitrarily sorted inductive definitions}
