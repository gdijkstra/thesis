...
\todoi{Formulate and establish completeness for container morphisms}
...
\todoi{Explain $\Fam$ case via presheaf formulation}
...
\todoi{Explain how we get an adjunction with $\Set$ as well and how
  this is our adjunction $L_0 \dashv U_0 : \Func{\Alg_0}{\Set}$}
...
\todoi{Show how natural numbers in $\Set$ and coequalisers in $\Cc$
  (arbitrary coproducts?)  are enough to establish that $\Cc$ has
  sequential colimits. Do this first in $\Set$ of course.}
