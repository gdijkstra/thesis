...
to construct left adjoints. An alternative approach would be to use
the adjoint functor theorem. We have already shown that the forgetful
functors preserve certain limits, so we could extend this to them
being continuous. We also would have to show that the sort categories
are complete.

For monad algebras, there are several results on colimits of monad
algebras \cite{Adamek1977i,Kelly1980,Barr1985}.
