...
\begin{proof}
  ...
  to also work when these equations hold only up to propositional
  equality.
\end{proof}
...
of inductive-inductive definitions \cite{Altenkirch2011} as well as a
restricted, \ie set truncated, form of higher inductive types of
\cite{Lumsdaine2013}.
